...
function changeOpacity1(opacity) {
    document.getElementById("desninovi").style.opacity = opacity;
}

function changeOpacity2(opacity) {
    document.getElementById("lijevinovi").style.opacity = opacity;
}
